...
import ApexChart from "../Scoreboard/RadialChart";
      ...
      >
        ...
        <div style={{ position: "fixed", bottom: "0", left: "22%" }}>
          <div className={styles.profileTitle}>
            Can you show your support {user ? user.nickname : "GUEST"} by
            sharing our website with your friends?
          </div>
          <style
