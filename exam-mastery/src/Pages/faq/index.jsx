  ...
  return (
    <Box m="20px">
      ...
      <Accordion defaultExpanded>
        ...
        <AccordionDetails>
          <Typography>
          TOEFL® Master is the only official practice test that gives you the experience of taking the real
TOEFL iBT® test. You will practice by using authentic questions from past tests, and you will receive your
scores.
          </Typography>
        </AccordionDetails>
      </Accordion>
